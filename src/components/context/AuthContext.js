...
//children is a parameter being passed through to this functional component that allow child components to be referred to as children.
export function AuthProvider({children}){
    ...
    //The authHandler function details what we want to do with the user info we receive from GitHub
    ...
    //Keep updated record of user info using the useEffect() uef => tab
    useEffect(() => {
        ...
        //unsubscribe the firebase app since we have what we need from it.
        return authChange;
    }, []);

...
//Install a pkg from npm that will render Bootstrap enabled HTML when we call to the components from react-bootstrap - npm install react-bootstrap
import { Container, Row, Col, Carousel, Accordion } from 'react-bootstrap';

//images to import
import image from '../../components/images/images/background.jpg'
import image2 from '../../components/images/images/background2.jpg'
import image3 from '../../components/images/images/background3.jpg'

export default function Bootstrap() {
  return (
      <section className='bootstrap'>
          <main>
              {/* Below we used the carousel component from react-bootstrap. This will render the HTML necessary to make a functioning carousel using bootstrap classed/html */}
                      ...
                      <Col md={{span: 8, offset: 2}}>
                          <Accordion>
                              <Accordion.Item eventKey="0">
                                  ...
                                  <Accordion.Body>
                                    <p>npm install react-bootstrap@5.1.3</p>
                                  </Accordion.Body>
                              </Accordion.Item>
